...
export default function Contact() {
  ...
  return (
    <section className="container" style={{ position: 'relative', zIndex: 1, padding: 'var(--space-5) var(--space-3)', maxWidth: '60ch' }}>
      ...
      <p>
        Do you have a specific design in mind, or a stone you'd like set? A question about an item in the shop, or about something else? Drop me a line and I'll follow up by email.
      </p>
